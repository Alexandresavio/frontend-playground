...
console.log(escola.charCodeAt(3));//retorna o codigo unicode da tabela Asc que é 51
console.log(escola.indexOf('c'));// retorna em qual indice esta aquele caracter enviado como parametro 
