...
//1º exemplo constante recebendo uma funcao anonima(sem retorno) 
...
//2º exemplo constante recebendo uma funcao anonima(com retorno) 
const imprimirMultiplicacao = function(c, d){
    return( c * d);
}
//chamda da funcao
console.log(`Resultado da multiplicação = ${imprimirMultiplicacao(2,5)}`)
